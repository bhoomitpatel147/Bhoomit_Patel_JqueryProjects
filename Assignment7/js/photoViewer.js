$(function () {
    ...
    $(document).on('click', '.thumbnail-anchor', function customPhotoViewer(e) { // Click on thumb
        ...
        $thumbs.removeClass('active').css("border","none"); // Remove active from thumbs
        $(this).addClass('active').css("border","2px ridge red"); // Add active to clicked one
        ...
        if (cache.hasOwnProperty(src)) { // If cache contains this img
            ...
            $loading.addClass('is-loading'); // Add is-loading to frame
